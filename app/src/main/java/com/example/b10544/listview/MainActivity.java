package com.example.b10544.listview;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //어댑터 생성
        ListAdapter adapt = createAdapter4();
        //어탭터 연결
    ...
    private ListAdapter createAdapter2() {
       //어댑터 준비 (리소스 배열 객체 이용, simple_list_item_1리소스 사용
        //안드로이드에서 제공하는 기본 뷰에 arrays.xml의 item 값들을 할당
    ...
    private ListAdapter createAdapter4(){
        ...
        //simple_list_item_2  뷰에 mlist 해시맵 값들을 할당
